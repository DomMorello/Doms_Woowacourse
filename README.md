...
✅ 프론트엔드 성능을 측정, 분석하고 개선해본다.<br>
✅ TypeScript를 깊이있게 이해하고 다뤄본다.<br>
...
✅ 개발 프로세스 기반으로 프로젝트 기획과 진행 및 협업하는 경험을 한다.<br>
...
✅ 각 레벨 별로 한 편의 글을 완성하도록 한다.<br>
✅ 한 편의 글에 자신의 생각과 감정을 논리적으로 담을 수 있도록 한다.<br>
✅ 독자가 이해하기 쉬운 글을 작성한다.
